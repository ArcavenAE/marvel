...
# create-app.sh - Create a macOS .app bundle for marvel
...
APP_BUNDLE="${OUTPUT_DIR}/Marvel.app"

rm -rf "$APP_BUNDLE"
mkdir -p "$APP_BUNDLE/Contents/MacOS"
mkdir -p "$APP_BUNDLE/Contents/Resources"

cp "$BINARY_PATH" "$APP_BUNDLE/Contents/MacOS/marvel"
chmod +x "$APP_BUNDLE/Contents/MacOS/marvel"
