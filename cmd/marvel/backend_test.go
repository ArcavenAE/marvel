	...
	tests := []struct {
		...
		},
		{
			...
			report: []api.BackendVerification{{
				...
				Label:            "bedrock (iam)", OK: true,
			}},
			contains: []string{"aae/dev-1", "bedrock (iam)", "aws-credential-export", "ok"},
		...
		},
		{
			...
			report: []api.BackendVerification{{
				...
				Label: "bedrock (static)", CredentialSource: api.BackendCredentialAmbient,
