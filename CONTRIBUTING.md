...
```bash
git clone https://github.com/ArcavenAE/marvel.git
cd marvel
just build    # Build
just test     # Run tests
...
Open a [Bug Report](https://github.com/ArcavenAE/marvel/issues/new?template=bug-report.yml) and include:
...
Open a [Feature Request](https://github.com/ArcavenAE/marvel/issues/new?template=feature-request.yml).
